...
/**
 * Runtime configuration for an area-of-effect, used by spells (e.g. Zap, Freeze, Poison)
 * and deploy effects (e.g. ElectroWizard entry stun).
 *
...
public class AreaEffectStats {
  ...
  @Builder.Default
  private final float lifeDuration = 0f;
  @Builder.Default
  private final boolean hitsGround = true;
  @Builder.Default
  private final boolean hitsAir = true;
  ...
  @Builder.Default
  private final float hitSpeed = 0f;
