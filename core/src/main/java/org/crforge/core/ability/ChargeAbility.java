...
/**
 * Charge ability data (Prince, Dark Prince, Battle Ram). Troop builds charge while moving; once
 * fully charged, the next attack deals bonus damage and the troop moves faster.
 *
