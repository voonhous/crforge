...
/**
 * Hook ability data (Fisherman).
 * Troop throws a hook to pull the target toward itself, then drags itself toward the target.
 *
 ...
 * @param hookDragBackSpeed speed at which the target is pulled (raw units, divided by 60 at runtime)
