...
/**
 * Reflect ability data (Electro Giant).
 * When a melee attacker hits this troop within the reflect radius, counter-damage and
 * an optional debuff are applied to the attacker.
 *
