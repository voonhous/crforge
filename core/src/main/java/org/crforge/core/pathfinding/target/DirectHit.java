...
@Fidelity(
    ...
    note =
        "Settled: the crown-tower damage from the plain damage, the hit id counted before the"
            ...
            + " hit touches nothing. Held by every hit of the kill run. Not modelled: the damage"
            + " effect and the fallback, the area damage, the attacker's buffs changing either"
