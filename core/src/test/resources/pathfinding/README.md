...
- `gift_knight`: a Knight spawned on its owner at (14500, 12000) on tick 5, walking at once: its registration visit takes PrincessTower_1_2 as its target and steps to (14518, 12056). The tower locks on 81, the Knight hits from 195 and dies on 308.
