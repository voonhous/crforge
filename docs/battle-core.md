...
- A tower has no components, so it never attacks, although its projectile row and launch columns are carried. Its elapsed time therefore stands at zero, which a tower's own default selection will read once it has a targeting component.
